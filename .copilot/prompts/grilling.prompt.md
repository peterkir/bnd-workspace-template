...
name: grilling
description: >
  Grill the user relentlessly about a plan, decision, or idea. Use when the user wants
...
Finding _facts_ is your job, never the user's. When a frontier question needs a fact
