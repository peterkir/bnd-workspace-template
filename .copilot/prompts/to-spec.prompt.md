...
name: to-spec
description: >
  Turn the current conversation into a spec (PRD) and publish it to the project issue
...
- [issue-tracker.md](./issue-tracker.md) — where issues live and how to publish them
- [triage-labels.md](./triage-labels.md) — the triage label vocabulary
- [domain-docs.md](./domain-docs.md) — how to consume `CONTEXT.md` and ADRs

## Process

1. Explore the repo to understand the current state of the codebase, if you haven't
   already. Follow [domain-docs.md](./domain-docs.md): use the project's domain
   glossary vocabulary throughout the spec, and respect any ADRs in the area you're
   touching.
...
3. Write the spec using the template below, then publish it to the project issue
   tracker per [issue-tracker.md](./issue-tracker.md). Apply the `ready-for-agent`
   triage label from [triage-labels.md](./triage-labels.md) - no need for additional
   triage.
...
<user-story-example>
1. As a mobile bank customer, I want to see balance on my accounts, so that I can make
